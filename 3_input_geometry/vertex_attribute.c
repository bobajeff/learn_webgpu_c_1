...
struct Context ctx = { myCallback };

static void cCallback(WGPUErrorType type, char const* message, void* userdata) {
...
int main(int argc, char *argv[]) {
	...
	wgpuDeviceSetUncapturedErrorCallback(device, cCallback, (void *)(&ctx));
